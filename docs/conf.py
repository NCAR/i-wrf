...
release = f'{version}'
release_year = '2023'
release_date = f'{release_year}-01-30'
...
latex_theme = 'manual'
latex_logo = os.path.join('_static','RAL-contemp-logo-blue-square.png')
...
# of the sidebar.
html_logo = os.path.join('_static','RAL-contemp-logo-blue-square.png')
