...
WPS Namelist
^^^^^^^^^^^^
Use this `namelist.wps file <https://github.com/NCAR/i-wrf/blob/main/use_cases/Hurricane_Matthew/WRF/namelist.wps>`_ when running WPS for the Hurricane Matthew case, from the GitHub repository.
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Use this `namelist.input file <https://github.com/NCAR/i-wrf/blob/main/use_cases/Hurricane_Matthew/WRF/namelist.input>`_ when running WRF for the Hurricane Matthew case, from the GitHub repository.
...
Use this `vars_io.txt file <https://github.com/NCAR/i-wrf/blob/main/use_cases/Hurricane_Matthew/WRF/vars_io.txt>`_ for the Hurricane Matthew case, from the GitHub repository.

^^^^^^^^^^^^^^^^^^^
METplus Config File
^^^^^^^^^^^^^^^^^^^
For the METplus configuration file for the Hurricane Matthew case, please use `this file on the GitHub repository. <https://github.com/NCAR/i-wrf/blob/main/use_cases/Hurricane_Matthew/METplus/PointStat_matthew.conf>`_
